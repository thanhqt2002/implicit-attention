...
def get_imagenet_c_results(model, imagenet_c_tiny_mask=None):
    result_dict = {}
...
def main(args):
    ...
    PATH_TO_IMAGENET_R = "/root/datasets/imagenet-r"
    PATH_TO_IMAGENET_A = os.path.join(args.data_path, 'imagenet-a')
    PATH_TO_IMAGENET_O = "/root/datasets/imagenet-o"
    PATH_TO_IMAGENET_VAL = '/root/tensorflow_datasets/downloads/manual/val/'
    ...
    imagenet_o_folder = "/root/datasets/imagenet_o_val/"
